...
<html>
    ...
    <body>
        <div class="container">
            <a href="try.php">ახალი ვერსია</a> &nbsp; <a href="calculator.php">მანძილი/სიჩქარე/დრო</a> &nbsp;<a href="graphical.php">MM</a>
            <div class="row">
                    ...
                    <table style="width:370px" >
                        ...
                        <tbody>
                            ...
                            <tr id="roundTr">
                                ...
                                <td >ბრუნის დრო</td><td>საათი<br><input id="roundInputHour" class="input" type="number" min="-1" disabled="true" value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td><td>წუთი<br><input id="roundInputMinute" class="input" type="number" disabled="true" value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td><td>წამი<br><input id="roundInputSecond" class="input" type="number" disabled="true" value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td>

                            </tr>
                            <tr id="busTr">
                                <td><input id="busCheckBox" type="checkbox" onclick="checkCheckBoxes(event)" ></td>
                                <td>ავტობუსების<br> რაოდენობა</td><td colspan="3"><input id="busInput" class="input" type="number" disabled="true" style="width:125px;" max="200" min="1" value="0" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td>
                            </tr>
                            <tr id="intervalTr">
                                <td><input id="intervalCheckBox" type="checkbox" onclick="checkCheckBoxes(event)"></td>
                                <td>ინტერვალი</td><td>საათი<br><input id="intervalInputHour" class="input" type="number" min="-1" disabled="true" value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td><td>წუთი<br><input id="intervalInputMinute" class="input" type="number" disabled="true" value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td><td>წამი<br><input id="intervalInputSecond" class="input" type="number" disabled="true"  value="00" oninput="adjastTimeInputs(event)" onkeyup="incoming(event)" onfocus="this.select()"></td>
                            </tr>
